...
\hline
Date               & \begin{tabular}[c]{@{}c@{}}Description\\ of work\end{tabular}                                & \begin{tabular}[c]{@{}c@{}}Library/\\ Laboratory/\\ Field work\end{tabular} & \begin{tabular}[c]{@{}c@{}}Signature\\ of\\ Authority\end{tabular} & \begin{tabular}[c]{@{}c@{}}Signature\\ of Guide\end{tabular} \\ \hline
August 30, 2019    & Began Literature Review.                                                                     & Library                                                                     &                                                                    &                                                              \\ \hline
September 27, 2019 & \begin{tabular}[c]{@{}c@{}}Shortlisted machine learning\\ algorithms to test.\end{tabular}   & Library                                                                     &                                                                    &                                                              \\ \hline
October 25, 2019   & \begin{tabular}[c]{@{}c@{}}Presented outline of\\ models and workflow.\end{tabular}          & Library                                                                     &                                                                    &                                                              \\ \hline
October 27, 2019   & \begin{tabular}[c]{@{}c@{}}Began EDA and machine\\ learning algorithm phase.\end{tabular}    & Laboratory                                                                  &                                                                    &                                                              \\ \hline
November 22, 2019  & \begin{tabular}[c]{@{}c@{}}Began writing algorithm\\ for distributed computing.\end{tabular} & Laboratory                                                                  &                                                                    &                                                              \\ \hline
December 13, 2019  & Began API Development.                                                                       & Laboratory                                                                  &                                                                    &                                                              \\ \hline
January 17, 2020   & \begin{tabular}[c]{@{}c@{}}Began work on\\ Web Application.\end{tabular}                     & Laboratory                                                                  &                                                                    &                                                              \\ \hline
January 31, 2020   & \begin{tabular}[c]{@{}c@{}}Algorithm subjected to\\ testing and modifications.\end{tabular}  & Laboratory                                                                  &                                                                    &                                                              \\ \hline
February 21, 2020  & \begin{tabular}[c]{@{}c@{}}Testing whole system\\ complete.\end{tabular}                     & Laboratory                                                                  &                                                                    &                                                              \\ \hline
\end{tabular}
\end{table}
\endgroup
...
\end{tabular}
\captionof{table}{Multi Layered Perceptron 5 fold verification.}
\label{table:7}
\end{table}
}
