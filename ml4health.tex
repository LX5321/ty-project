...
\begin{titlepage}
    \begin{center}
        ...
        \normalsize
        \vspace{0cm}
        Approaches to qualify and implement Machine learning algorithms in healthcare sector.
